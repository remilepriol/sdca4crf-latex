...
\section{Anterior Works}
The problem \ref{primal problem} is long running.
A number of approach has been tried.
The difficulty arises from the high dimensionality d, and  most importantly from the number of samples n.
In 2001, \cite{lafferty_conditional_2001} described the setting and proposed an iterative scaling approach.
...
Deterministic algorithms require computing probabilities for the n examples. 
