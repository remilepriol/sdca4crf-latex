...
In his paper \cite{shalev-shwartz_accelerated_2013-1}, Shalev-Shwartz describes and analyzes a version of the Stochastic Dual Coordinate Ascent (SDCA) algorithm for multi-class classification problems.
...
For instance, in the Optical Character Recognition dataset \cite{taskar_max-margin_2004}, the mean word length is 7.5.
...
\section{Background}
The problem \ref{primal problem} has been studied for a long time.
