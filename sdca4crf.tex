...
We propose a Non-Uniform adaptive Sampling scheme to improve the convergence speed.
...
This especially true at the beginning because we initialize SDCA with the uniform distribution.
...
It increases as we expect.
If not for the duality gap, it looks converging.
...
This project is still going at the MILA.
